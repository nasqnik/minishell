...
/*   Updated: 2024/12/25 16:07:31 by anikitin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 			f->i++;
// 		}
// 		while (str[f->i] && str[f->i] != ')' && ((brackets_num > 1
// 					&& (ft_isdigit(str[f->i]) == 1 || ft_isop(str[f->i]) == 1
// 						|| ft_isspace(str[f->i]) == 1)) || (brackets_num == 1)))
// 			f->i++;
