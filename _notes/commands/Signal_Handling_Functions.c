...
// The sigemptyset function is used to initialize a signal set to exclude all signals.
// It clears all bits in the signal set, effectively creating an empty signal set.
